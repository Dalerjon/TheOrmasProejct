...
const QMetaObject InfoForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InfoForm.data,
      qt_meta_data_InfoForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InfoForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InfoForm.stringdata0))
        return static_cast<void*>(const_cast< InfoForm*>(this));
    if (!strcmp(_clname, "Ui::AboutDlg"))
        return static_cast< Ui::AboutDlg*>(const_cast< InfoForm*>(this));
