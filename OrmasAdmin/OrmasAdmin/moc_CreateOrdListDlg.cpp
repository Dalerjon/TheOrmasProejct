...
QT_MOC_LITERAL(7, 87, 10), // "OpenOrdDlg"
...
QT_MOC_LITERAL(13, 146, 9) // "childName"
    ...
    "CreateOrdListDlg\0DataIsChanged\0\0"
    "AddProductToList\0EditProductInList\0"
    "DeleteProduct\0Close\0OpenOrdDlg\0"
...
void CreateOrdListDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CreateOrdListDlg::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CreateOrdListDlg::DataIsChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CreateOrdListDlg::DataIsChanged()
{
