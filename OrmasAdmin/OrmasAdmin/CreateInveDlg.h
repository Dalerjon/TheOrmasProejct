...
private:
	...
	void SetInventoryParams(QString, double, QString, QString, int, QString, QString, QString, int, int = 0);
	void FillEditElements(QString, double, QString, QString, int, QString, QString, QString, int);
