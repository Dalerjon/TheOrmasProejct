...
public:
    ...
    void setupUi(QDialog *CreateReturn)
    {
        ...
        gridLayout->addWidget(statusWidget, 8, 0, 1, 6);
        ...
        warehouseLb = new QLabel(CreateReturn);
        warehouseLb->setObjectName(QStringLiteral("warehouseLb"));

        gridLayout->addWidget(warehouseLb, 7, 0, 1, 1);

        warehouseCmb = new QComboBox(CreateReturn);
        warehouseCmb->setObjectName(QStringLiteral("warehouseCmb"));

        gridLayout->addWidget(warehouseCmb, 7, 2, 1, 2);
    ...
    void retranslateUi(QDialog *CreateReturn)
    {
        ...
        warehouseLb->setText(QApplication::translate("CreateReturn", "Select warehouse:", 0));
    } // retranslateUi
