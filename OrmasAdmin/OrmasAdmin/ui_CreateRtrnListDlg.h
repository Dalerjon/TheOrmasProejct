...
public:
    ...
    void setupUi(QDialog *CreateRtrnList)
    {
        ...
        QWidget::setTabOrder(countEdit, returnBtn);
        QWidget::setTabOrder(returnBtn, returnEdit);
        QWidget::setTabOrder(returnEdit, statusBtn);
...
#endif // QT_NO_TOOLTIP
        statusBtn->setText(QApplication::translate("CreateRtrnList", "Select status", 0));
        returnBtn->setText(QApplication::translate("CreateRtrnList", "Select return", 0));
        returnEdit->setText(QString());
        currencyBtn->setText(QApplication::translate("CreateRtrnList", "Select currency", 0));
    } // retranslateUi
