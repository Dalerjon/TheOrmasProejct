...
namespace BusinessLayer
{
	...
	public:
		...
		bool ChangingByReceiptRaw(DataLayer::OrmasDal& ormasDal, int rrID, int empID, int stockEmpID, std::string& errorMessage);
		bool ChangingByReceiptRaw(DataLayer::OrmasDal& ormasDal, int rrID, int empID, int stockEmpID, std::map<int, double> pProdCountMap, double pSum, std::string& errorMessage);
		bool ChangingByReceiptRawAtSecondStock(DataLayer::OrmasDal& ormasDal, int rpID, int credWerID, std::string& errorMessage);
		bool ChangingByReceiptRawAtSecondStock(DataLayer::OrmasDal& ormasDal, int rpID, int credWerID, std::map<int, double> pProdCountMap, double pSum, std::string& errorMessage);
		...
		bool CreateEntry(DataLayer::OrmasDal& ormasDal, int id, int debAccID, double currentSum, int credAccID, std::string& errorMessage);
		bool CreateEntry(DataLayer::OrmasDal& ormasDal, int id, int debAccID, double currentSum, int credAccID, double previousSum, std::string& errorMessage);
