...
namespace BusinessLayer{
	...
	private:
		...
		bool Replenishment(DataLayer::OrmasDal& ormasDal, int sID, int cID, std::string& errorMessage);
		bool Replenishment(DataLayer::OrmasDal& ormasDal, int sID, int cID, double previousValue, std::string& errorMessage);
