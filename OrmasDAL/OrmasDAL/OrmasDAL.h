...
namespace DataLayer{
	...
	public:
		...
		std::vector<productListViewCollection> GetProductLists(std::string& errorMessage, std::string filter = std::string());
		...
		bool CreateOrder(int oID, int uID, std::string oDate, int wID, int oCount, double oSum, int sID, int cID, std::string& errorMessage);
		bool CreateProductList(int pListID, int oID, int rID, int pnID, int pID, int pListCount, double pListSum, int sID, int cID, std::string& errorMessage);
		...
		bool CreateReturn(int rID, int uID, std::string rDate, int wID, int rCount, double rSum, int sID, int cID, std::string& errorMessage);
		...
		bool CreateUser(int uID, std::string uName, std::string uPhone, std::string uAddress, std::string uFirm,
		...
		bool UpdateOrder(int oID, int uID, std::string oDate, int wID, int oCount, double oSum, int sID, int cID, std::string& errorMessage);
		bool UpdateProductList(int pListID, int oID, int rID, int pnID, int pID, int pListCount, double pListSum, int sID, int cID, std::string& errorMessage);
		...
		bool UpdateLocation(int lID, std::string lCountryName, std::string lCountryCode, std::string lRegionName
			, std::string lCityName, std::string& errorMessage);
		bool UpdateReturn(int rID, int uID, std::string rDate, int wID, int rCount, double rSum, int sID, int cID, std::string& errorMessage);
		...
		bool UpdateUser(int uID, std::string uName, std::string uPhone, std::string uAddress, std::string uFirm,
			std::string uFirmNumber, int uRoleID, int uLocationID, std::string uPassword, bool uActivated, std::string& errorMessage);
		...
		std::string GetFilterForOrder(int oID, int uID, std::string oDate, int wID, int oCount, double oSum, int sID, int cID);
		std::string GetFilterForProductList(int pListID, int oID, int rID, int pnID, int pID, int pListCount, double pListSum, int sID, int cID);
		...
		std::string GetFilterForProduct(int pID, int cID, std::string pName, double vol, int mID, double price, int pTypeID, int pShelfLife, int pCur);
		...
		std::string GetFilterForReturn(int rID, int uID, std::string rDate, int wID, int rCount, double rSum, int sID, int cID);
		std::string GetFilterForRole(int rID, std::string rName, std::string rComment);
		std::string GetFilterForStatus(int sID, std::string sCode, std::string sName,std::string sComment);
		std::string GetFilterForUser(int uID, std::string uName, std::string uPhone, std::string uAddress, std::string uFirm, std::string uFirmNumber,
			int uRoleID, int uLocationID, std::string uPassword, bool uActivated);
